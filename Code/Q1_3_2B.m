...
[parameter_hat,RESNORM,EXITFLAG,OUTPUT]=fminunc('ZeppelinStickSSD',startx,h,Avox,bvals,qhat);
...
for i=1:epochs
    ...
    [parameter_hat,resnorm,~,~] = fminunc('ZeppelinStickSSD', newStart, h, Avox, bvals,qhat);
...
bestResnorm = lowest;
save('../mats/q1_3_2B.mat','bestParamHat','bestResnorm');
